...
COPY --from=docker.io/bitnami/kubectl:1.33.1@sha256:9494d9c200225a2a97d88b6616c2afa2ccbacdc62a87a0b65e1253769e6a0737 /opt/bitnami/kubectl/bin/kubectl /usr/bin/kubectl
